...
void __attribute__((picinterrupt(("")))) counting(void){
    if (INTCONbits.TMR0IF && INTCONbits.TMR0IE){
        TMR0L = 0xFFFF - (unsigned int)(0.997*10);
        TMR0H = (0xFFFF - (unsigned int)(0.997*10))>>8;
        ...
        switch (state_machine){
            ...
            case BUTTONA:
                if (button == 3 || button == 2){
                    if (state_butA == PRESS) LATD = LED_display++;
                    state_machine = NORMAL;
                    state_butA = PRESS;
                    count_but1 = 0;
                }
                    ...
                    case PRESS:
                        if (count_but1 > 1000/10 && count_but1 < 3000/10) state_butA = HOLD_FIRST;
                        break;
                    case HOLD_FIRST:
                        if (count_but1 > 3000/10) state_butA = HOLD_SECOND;
                        if (LED_count > 500/10) {
                            LATD = LED_display++;
                            LED_count = 0;
                        }
            ...
            case BUTTONB:
                if (button == 3){
                    ...
                    case PRESS:
                        if (count_but2 > 1000/10 && count_but2 < 3000/10) state_butB = HOLD_FIRST;
                        break;
                    case HOLD_FIRST:
                        if (LED_count > 500/10) {
                            LATD = LED_display--;
                        ...
                        if (count_but2 > 3000/10) state_butB = HOLD_SECOND;
                        break;
                    case HOLD_SECOND:
                        if (LED_count > 100/10) {
                            LATD = LED_display--;
