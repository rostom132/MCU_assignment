...
void initial_register(void){
    uint32_t temp = register_timer(0,40,read_button_A,((void*)0));
    temp = register_timer(1000,500,readTempAndHumid,((void*)0));
    temp = register_timer(20,40,read_button_B,((void*)0));
}
